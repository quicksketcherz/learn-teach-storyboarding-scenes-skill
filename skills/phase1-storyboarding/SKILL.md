...
| # | Step | Time |
|---|------|------|
| 1 | Sketch 4 frames + 1 freestyle | 5 min |
| 2 | Annotate | 5 min |
...
**Picking principle:** lean toward sequences you find **cool / resonant** — work you genuinely enjoy. Easier to pick, easier to learn from when you actually love it. Don't overthink "is this the optimal training sequence" — pick the one that pulls you.
...
After Step 3 of Round 1 (and before wrap-up), ask:

> *"Round 2 — next person's sequence ready?"*

If yes, conduct Round 2 the same way starting from prep. If they're done after Round 1, skip to Step 5 (wrap-up).

### Step 5 — Wrap-up + reflection. ~5 min. *(After final round only.)*

> Bring it home. Quick reflection on what the Phase 1 session taught.
>
...
> - [Staging in Animation: A Beginner's Guide — VSQUAD](https://vsquad.art/blog/what-is-staging-in-animation-a-complete-beginners-guide) — the silhouette test, rule of thirds, leading lines.
> - [Negative Space: Film Composition Guide — Filmmakers Academy](https://www.filmmakersacademy.com/blog-negative-space-film/) — how empty space carries emotion and meaning.
> - [What is Negative Space — StudioBinder](https://www.studiobinder.com/blog/what-is-negative-space-definition/) — definitions + film examples.
>
...
People interrupt sessions. They say "wait, I want to re-pick the sequence" mid-sketch, or "extend the 5 min — I'm onto something." Honor the request. The structure is a default, not a contract. Template is the conversation scaffold, not a cage.
...
- **Run 30–90 seconds** — long enough to have several distinct compositions, short enough to scrub through quickly.
- **Have held, composed frames** — shots you can pause on and study, not a chaotic 30-cut montage. The artist needs frames worth stealing.
